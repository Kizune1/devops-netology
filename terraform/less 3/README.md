# Домашнее задание к занятию 3. «Управляющие конструкции в коде Terraform» Повечеровский А.В
...
```
    Добалвен ключ depends_on = [ yandex_compute_instance.web ]
```
4. Используйте функцию file в local переменной для считывания ключа ~/.ssh/id_rsa.pub и его последующего использования в блоке metadata, взятому из ДЗ №2.
```
    Данные берутся из файла [./meta.yml](./res/meta.yml)
```
...
![Output vms](./res/output%20vms.png)
...
[Код к шестому заданию.](./res/task%206/)